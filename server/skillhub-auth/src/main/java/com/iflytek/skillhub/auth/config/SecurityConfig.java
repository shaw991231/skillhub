...
public class SecurityConfig {
    ...
    private final FeishuOAuth2AccessTokenResponseClient feishuTokenResponseClient;
    ...
    public SecurityConfig(CustomOAuth2UserService customOAuth2UserService,
                          FeishuOAuth2AccessTokenResponseClient feishuTokenResponseClient,
        ...
        this.feishuTokenResponseClient = feishuTokenResponseClient;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .oauth2Login(oauth2 -> oauth2
                ...
                .tokenEndpoint(token -> token.accessTokenResponseClient(feishuTokenResponseClient))
